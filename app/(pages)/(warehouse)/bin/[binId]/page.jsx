...
import { useFetchBinById, useSubmitBin } from "@/modules/warehouse/bin/hooks";
...
export default function BinUpdate() {
  ...
  const { bin, loading: loadingBin } = useFetchBinById(binId);
  ...
  const onSubmitHandler = useSubmitBin({
    mode: "update",
    binId,
    userId,
  });
